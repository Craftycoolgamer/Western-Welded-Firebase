  ...
  return (
    <footer className="site-footer">
      <div className="footer-container">
        ...
        <div className="footer-section show">
          <h4>Connect With Us</h4>
          <div className="social-links">
            <a href="https://www.instagram.com/westernweldedco" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://www.youtube.com/@westernweldedco" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://www.tiktok.com/@westernweldedco" target="_blank" rel="noopener noreferrer">
      ...
      <div className="footer-bottom">
        <p>&copy; {new Date().getFullYear()} Western Welded. All rights reserved.</p>
      </div>
    </footer>
  );
}
